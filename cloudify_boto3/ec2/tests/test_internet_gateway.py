...
from cloudify_boto3.ec2.resources.internet_gateway import EC2InternetGateway, \
    INTERNETGATEWAYS, INTERNETGATEWAY_ID, \
    VPC_ID, VPC_TYPE
from mock import patch, MagicMock
from cloudify_boto3.ec2.resources import internet_gateway
