...
from cloudify_boto3.ec2.resources.vpn_gateway import EC2VPNGateway, \
    VPNGATEWAYS, VPNGATEWAY_ID, \
    VPC_ID, VPC_TYPE
from mock import patch, MagicMock
from cloudify_boto3.ec2.resources import vpn_gateway
    ...
    def test_class_attach(self):
        ...
        self.vpn_gateway.client = \
            self.make_client_function('attach_vpn_gateway',
                                      return_value=value)
        with patch('cloudify_boto3.ec2.resources.vpn_gateway'
