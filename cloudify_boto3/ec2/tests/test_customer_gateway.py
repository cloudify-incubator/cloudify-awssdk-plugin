...
from cloudify_boto3.ec2.resources.customer_gateway import EC2CustomerGateway, \
    CUSTOMERGATEWAYS, CUSTOMERGATEWAY_ID, \
    ELASTICIP_TYPE
from mock import patch, MagicMock
from cloudify_boto3.ec2.resources import customer_gateway
...
class TestEC2VPNGateway(TestBase):
    ...
    def setUp(self):
        ...
        mock1 = patch('cloudify_boto3.common.decorators.aws_resource',
                      mock_decorator)
        mock2 = patch('cloudify_boto3.common.decorators.wait_for_status',
                      mock_decorator)
        mock3 = patch('cloudify_boto3.common.decorators.wait_for_delete',
                      mock_decorator)
        mock1.start()
        mock2.start()
        mock3.start()
    ...
    def test_class_create(self):
        ...
        self.assertEqual(res, value['CustomerGateway'])
