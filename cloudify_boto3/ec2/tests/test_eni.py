...
from cloudify_boto3.ec2.resources.eni import EC2NetworkInterface, \
    NETWORKINTERFACES, NETWORKINTERFACE_ID, SUBNET_ID, \
    SUBNET_TYPE, INSTANCE_TYPE_DEPRECATED, ATTACHMENT_ID
from mock import patch, MagicMock
from cloudify_boto3.ec2.resources import eni
    ...
    def test_class_attach(self):
        ...
        self.eni.client = \
            self.make_client_function('attach_network_interface',
                                      return_value=value)
        with patch('cloudify_boto3.ec2.resources.eni'
