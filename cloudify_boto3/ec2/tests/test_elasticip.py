...
from cloudify_boto3.ec2.resources.elasticip import EC2ElasticIP, \
...
from cloudify_boto3.ec2.resources import elasticip
    ...
    def test_class_attach(self):
        ...
        self.elasticip.client = \
            self.make_client_function('associate_address',
                                      return_value=value)
        with patch('cloudify_boto3.ec2.resources.elasticip'
                   '.EC2ElasticIP.attach'):
