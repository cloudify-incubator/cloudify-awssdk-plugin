...
from cloudify_boto3.rds.resources import instance
...
class TestRDSInstance(TestBase):
    ...
    def test_create(self):
        ...
        fake_boto, fake_client = self.fake_boto_client('rds')
        with patch('boto3.client', fake_boto):
            fake_client.create_db_instance = MagicMock(return_value={
                'DBInstance': {
                    'DBInstanceIdentifier': 'devdbinstance',
            ...
            fake_client.create_db_instance.assert_called_with(
