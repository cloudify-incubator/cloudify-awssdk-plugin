...
from cloudify_boto3.elb.resources.listener import (ELBListener,
                                                   LISTENER_ARN, LB_ARN,
                                                   TARGET_ARN)
from cloudify_boto3.common.constants import EXTERNAL_RESOURCE_ARN
from mock import patch, MagicMock
from cloudify_boto3.elb.resources import listener

PATCH_PREFIX = 'cloudify_boto3.elb.resources.listener.'
