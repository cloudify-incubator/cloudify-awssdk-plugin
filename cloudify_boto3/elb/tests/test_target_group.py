...
from cloudify_boto3.elb.resources.target_group import (ELBTargetGroup,
                                                       VPC_ID,
                                                       TARGETGROUP_ARN,
                                                       GRP_ATTR)
from cloudify_boto3.common.constants import EXTERNAL_RESOURCE_ID
from mock import patch, MagicMock
from cloudify_boto3.elb.resources import target_group

PATCH_PREFIX = 'cloudify_boto3.elb.resources.target_group.'
