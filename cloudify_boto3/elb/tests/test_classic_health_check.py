...
from cloudify_boto3.elb.resources.classic.health_check import (
    ELBClassicHealthCheck, LB_NAME)
from cloudify_boto3.common.constants import EXTERNAL_RESOURCE_ID
from mock import patch, MagicMock
from cloudify_boto3.elb.resources.classic import health_check

PATCH_PREFIX = 'cloudify_boto3.elb.resources.classic.health_check.'
