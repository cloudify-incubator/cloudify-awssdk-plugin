...
from cloudify_boto3.sns.resources.subscription import (SNSSubscription,
                                                       SUB_ARN, TOPIC_ARN,
                                                       CONFIRM_AUTHENTICATED)
from mock import patch, MagicMock
from cloudify_boto3.sns.resources import subscription

PATCH_PREFIX = 'cloudify_boto3.sns.resources.subscription.'
