...
from cloudify_awssdk.ec2.resources.dhcp import EC2DHCPOptions, \
    DHCPOPTIONS, DHCPOPTIONS_ID, \
    VPC_ID, VPC_TYPE
from mock import patch, MagicMock
from cloudify_awssdk.ec2.resources import dhcp
    ...
    def test_class_attach(self):
        ...
        self.dhcp.client = \
            self.make_client_function('associate_dhcp_options',
                                      return_value=True)
        with patch('cloudify_awssdk.ec2.resources.dhcp'
