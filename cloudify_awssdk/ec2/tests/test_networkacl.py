...
from cloudify_awssdk.ec2.resources.networkacl import EC2NetworkAcl, \
    NETWORKACLS, NETWORKACL_ID, ASSOCIATION_SUBNET_ID, \
    VPC_ID, VPC_TYPE, SUBNET_ID, SUBNET_TYPE, ASSOCIATION_ID
from mock import patch, MagicMock
from cloudify_awssdk.ec2.resources import networkacl
...
class TestEC2NetworkAcl(TestBase):
    ...
    def test_class_create(self):
        ...
        self.assertEqual(res, value['NetworkAcl'])
