...
from cloudify_awssdk.ec2.resources.internet_gateway import (
    EC2InternetGateway,
    INTERNETGATEWAYS,
    INTERNETGATEWAY_ID,
    VPC_ID, VPC_TYPE)
from mock import patch, MagicMock
from cloudify_awssdk.ec2.resources import internet_gateway
    ...
    def test_class_attach(self):
        ...
        self.internet_gateway.client = \
            self.make_client_function('attach_internet_gateway',
                                      return_value=True)
        with patch('cloudify_awssdk.ec2.resources.internet_gateway'
