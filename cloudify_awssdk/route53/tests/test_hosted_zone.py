...
from cloudify_awssdk.route53.resources import hosted_zone
from cloudify_awssdk.common import constants

PATCH_PREFIX = 'cloudify_awssdk.route53.resources.hosted_zone.'
...
class TestHostedZone(TestBase):
    ...
    def setUp(self):
        ...
        mock1 = patch('cloudify_awssdk.common.decorators.aws_resource',
                      mock_decorator)
        mock2 = patch('cloudify_awssdk.common.decorators.wait_for_delete',
                      mock_decorator)
        mock3 = patch('cloudify_awssdk.common.decorators.aws_relationship',
                      mock_decorator)
        mock1.start()
        mock2.start()
        mock3.start()
