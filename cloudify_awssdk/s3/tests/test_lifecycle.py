...
from cloudify_awssdk.s3.resources.lifecycle_configuration import (
    S3BucketLifecycleConfiguration, BUCKET, RULES, ID)
from mock import patch, MagicMock
from cloudify_awssdk.common.constants import EXTERNAL_RESOURCE_ID
from cloudify_awssdk.s3.resources import lifecycle_configuration

PATCH_PREFIX = 'cloudify_awssdk.s3.resources.lifecycle_configuration.'
