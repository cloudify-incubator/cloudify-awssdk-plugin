...
from cloudify_awssdk.elb.resources.classic.policy import (ELBClassicPolicy,
                                                          RESOURCE_NAMES,
                                                          RESOURCE_NAME,
                                                          LB_NAME, LB_PORT,
                                                          LISTENER_TYPE)
...
from cloudify_awssdk.elb.resources.classic import policy

PATCH_PREFIX = 'cloudify_awssdk.elb.resources.classic.policy.'
