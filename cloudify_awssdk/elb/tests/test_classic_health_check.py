...
from cloudify_awssdk.elb.resources.classic.health_check import (
    ELBClassicHealthCheck, LB_NAME)
from cloudify_awssdk.common.constants import EXTERNAL_RESOURCE_ID
from mock import patch, MagicMock
from cloudify_awssdk.elb.resources.classic import health_check

PATCH_PREFIX = 'cloudify_awssdk.elb.resources.classic.health_check.'
