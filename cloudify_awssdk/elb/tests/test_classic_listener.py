...
from cloudify_awssdk.elb.resources.classic.listener import (ELBClassicListener,
                                                            LISTENERS, LB_NAME,
                                                            LB_PORT)
from cloudify_awssdk.common.constants import EXTERNAL_RESOURCE_ID
from mock import patch, MagicMock
from cloudify_awssdk.elb.resources.classic import listener

PATCH_PREFIX = 'cloudify_awssdk.elb.resources.classic.listener.'
