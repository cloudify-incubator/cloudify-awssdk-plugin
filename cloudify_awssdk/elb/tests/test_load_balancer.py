...
from cloudify_awssdk.elb.resources.load_balancer import (ELBLoadBalancer,
                                                         LB_ARN,
                                                         RESOURCE_NAME,
                                                         LB_ATTR)
from cloudify_awssdk.common.constants import EXTERNAL_RESOURCE_ID
from mock import patch, MagicMock
from cloudify_awssdk.elb.resources import load_balancer

PATCH_PREFIX = 'cloudify_awssdk.elb.resources.load_balancer.'
