...
from cloudify_awssdk.lambda_serverless.resources import invoke
...
LAMBDA_PATH = (
    'cloudify_awssdk.lambda_serverless.resources.invoke.LambdaFunction'
)
INVOKE_PATH = 'cloudify_awssdk.lambda_serverless.resources.invoke.'
